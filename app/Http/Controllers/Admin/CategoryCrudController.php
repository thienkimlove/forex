...
class CategoryCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('parent')->type('relationship')->label('Chuyên mục cha');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('parent')->type('relationship')->label('Chuyên mục Cha');
        CRUD::field('desc')->type('textarea')->label('Mô tả');
        CRUD::field('keywords')->type('textarea')->label('Từ khóa');
